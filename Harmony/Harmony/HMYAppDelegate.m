...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    HMYFavouriteStore *favouriteStore = [[HMYFavouriteStore alloc] init];
    
    HMYFilesViewController *browserViewController = [[HMYFilesViewController alloc] initWithPath:@"/"];
    [browserViewController setFavouriteStore:favouriteStore];
    ...
    HMYFavouriteViewController *favouriteViewController = [[HMYFavouriteViewController alloc] initWithFavouriteStore:favouriteStore];
    ...
    [tabBarController setViewControllers:@[browserNavigationController, favouriteNavigationController]];
